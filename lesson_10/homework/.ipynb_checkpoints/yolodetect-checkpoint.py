...
##        cv2.imshow("Largest aeroplane Region", cropped_img)
##        cv2.waitKey(0)
...
##            text = f"aeroplane: {confidences[indices.flatten()[0]]:.4f}"
##            cv2.putText(img, text, (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 2)
##
##            # Display the result
##            cv2.imshow("Detected aeroplane", img)
##            cv2.waitKey(0)
##            cv2.destroyAllWindows()
##
##            return (x, y, w, h)
